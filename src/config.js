...
export const VIDEO_LINK_EMBEDED_CODE_PARSER = process.env.REACT_APP_VIDEO_LINK_EMBEDED_CODE_PARSER ? process.env.REACT_APP_VIDEO_LINK_EMBEDED_CODE_PARSER : "https://media.proto.vit.tube/embed?url=";
