                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-9 col-md-10">
                                ...
                                <div className="payout small">
                                    Pending Payout: <span className="font-weight-bold">{ this.displayPayoutAmount(this.state.post.pending_payout_value) } VIT</span> <br/> { moment.utc(this.state.post.created).tz( moment.tz.guess() ).fromNow() } &middot; <Link  className="font-weight-bold" to={"/" + this.state.post.category + "/new"}>{this.state.post.category}</Link>
                                </div>
                                <div className="votes">
